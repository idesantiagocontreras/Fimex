...
$id = 'material';
$Material = new MaterialesVaciado();
        ...
        columns:[[
            ...
            {field:'IdProduccion',hidden:true,align:'center',editor:{type:'numberspinner',options:{precision:0}}},
            {
                ...
                editor:{
                    type:'combobox',
                    options:{
                        url:'/Fimex/produccion/data_materialt?IdProceso=$proceso',
                        method:'get',
            ...
            {field:'Cantidad',title:'Cantidad',width:80,align:'center',editor:{type:'timespinner',options:{precision:0}}},
