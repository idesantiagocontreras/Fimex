...
echo Html::beginTag('div',['id'=>'tbPedidos']);
    ...
    echo Html::a('Agregar Pedidos',"javascript:void(0)",[
        ...
        'ng-click'=>"loadProgramacionSemanal();",
    ]);
...
$this->registerJS("
    $('#$id').datagrid('enableFilter',[{
        ...
        options:{
            panelHeight:'150',
            panelWidth:'250',
            url:'/fimex/programacion2/marcas',
...
$this->registerJS("
    ...
    function addPedidos(grid){
        ...
        $.post('".URL::to('/fimex/programacion2/save_pedidos')."',
...
<table id="<?= $id ?>" class="easyui-datagrid datagrid-f" title="Agregar Pedidos" style="height:400px;" data-options="
    url:'/fimex/programacion-angular/pedidos',
    singleSelect:false,
    method:'post',
    collapsible:true,
    remoteSort:false,
...
">
    <thead>
        <tr>
            ...
            <th data-options="field:'OrdenCompra',width:100,">Orden</th>
