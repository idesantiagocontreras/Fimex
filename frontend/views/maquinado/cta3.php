...
<table id="<?php echo $id2 ?>" title="Semana <?=$sem?>"  class="easyui-datagrid " style="width:100%;height:auto;"
...
function formateo_op(index,row){
		...
		var i = 0 
		if (row.Matutino != null) i++;
		if (row.Vespertino != null) i++;
		if (row.Nocturno != null) i++;
