	...
	function initCss(){
		if (!$('#pivotgrid-style').length){
			$('head').append(
				...
				'.pivotgrid-item,.pivotgrid-item:hover{text-align:left;-moz-border-radius:0;-webkit-border-radius:0;border-radius:0;}' +
				'.pivotgrid-item-ins{border-top:1px solid red;}' +
				'.pg-fbar{padding:0;}' +
