    ...
    function c(c, g) {
        ...
        h.$el = a(c), h.el = c, h.id = e++, h.$window = a(b), h.$document = a(document), h.$el.bind("destroyed", a.proxy(h.teardown, h)), h.$clonedHeader = null, h.$originalHeader = null, h.isSticky = !1, h.hasBeenSticky = !1, h.leftOffset = null, h.topOffset = null, h.init = function() {
            ...
            h.$el && h.$el.each(function() {
                var b, c = a(this),
                    d = h.isWindowScrolling ? isNaN(h.options.fixedOffset) ? h.options.fixedOffset.outerHeight() : h.options.fixedOffset : h.$scrollableArea.offset().top + (isNaN(h.options.fixedOffset) ? 0 : h.options.fixedOffset),
                    e = c.offset(),
                    f = h.$scrollableArea.scrollTop() + d,
                    g = h.$scrollableArea.scrollLeft(),
                    i = h.isWindowScrolling ? f > e.top : d > e.top,
                    j = (h.isWindowScrolling ? f : 0) < e.top + c.height() - h.$clonedHeader.height() - (h.isWindowScrolling ? 0 : d);
            ...
            !h.isSticky || 0 > a || a + h.$window.height() > h.$document.height() || 0 > b || b + h.$window.width() > h.$document.width() || h.$originalHeader.css({
                ...
                left: h.leftOffset - (h.isWindowScrolling ? 0 : ((h.leftOffset-17)/2))
                
            })
            console.log(h.leftOffset+" - "+(((h.leftOffset+23)/40)+1))
            console.log(h.leftOffset - (h.isWindowScrolling ? 0 : (h.leftOffset == 17 ? b : 40*(((h.leftOffset+23)/40)+1))))
            ...
            return c.each(function(c) {
                var e, f = a(this);
                if ("border-box" === f.css("box-sizing")) e = f.outerWidth();
                else {
                    var g = a("th", h.$originalHeader);
                    if ("collapse" === g.css("border-collapse"))
